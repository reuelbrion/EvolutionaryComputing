...
public class player17_submission7 implements ContestSubmission 
{
	...
	final static double VARIANCE_TRESHOLD = 10d; //waarde van variance in fitness waarbij individuen worden vervangen door randoms
	...
	public void run()
	{
		...
		while(evals<evaluations_limit_/POPULATION_SIZE)
		{
			...
			System.out.println("best fitness: " + population.get(0).fitness + " worst fitness:  " + population.get(19).fitness + " evals: " + evals + " fitness vatriance: " + computeFitnessVariance());
			if(computeFitnessVariance() < VARIANCE_TRESHOLD)
			{
